...
async def create_template(
    ...
    template = Template(
        ...
        structure_guidance=body.structure_guidance,
        section_generation_guidance=body.section_generation_guidance,
        recommended_print_profile=body.recommended_print_profile,
        compatible_repository_traits=body.compatible_repository_traits,
        estimated_generation_scope=body.estimated_generation_scope,
        outline_preview=body.outline_preview,
