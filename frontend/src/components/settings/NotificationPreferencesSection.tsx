...
function Toggle({
  ...
  return (
    <button
      ...
      onClick={onPress}
      className={cn(
        'relative inline-flex h-5 w-9 shrink-0 rounded-full border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
        pressed ? 'border-interaction bg-interaction' : 'border-separator bg-panel-muted'
      )}
    >
      <span
        aria-hidden="true"
