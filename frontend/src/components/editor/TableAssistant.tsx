...
export function TableAssistant({ position, context, editor }: TableAssistantProps) {
  ...
  return (
    <div
      className="fixed z-50 flex items-center gap-1 px-1.5 py-1 bg-surface-elevated border border-border-default rounded-md shadow-lg animate-in fade-in zoom-in-95 duration-100"
      style={{
        top: position.top - 40,
        left: position.left,
